...
---
flowchart TD
    classDef screen fill:#2D3748,stroke:#4A5568,stroke-width:2px,color:#fff,rx:5px,ry:5px;
    ...
    A([Splash Screen]):::screen --> B{Sudah Login?}:::decision
    B -- Belum --> C[Onboarding / Auth]:::screen
    C --> D[Register Screen]:::screen
    D -->|Input Data, KTP, Selfie| V[Proses e-KYC]:::process
    C --> E[Login Screen]:::screen
    E -->|Password / Biometric| V2[Proses Auth]:::process
    V --> G([Berhasil Masuk])
    V2 --> G
    
    B -- Sudah --> G
    G --> H[Home / Dashboard Screen]:::screen
    H --> I{Cek Status Pinjaman}:::decision
    I -- Ada Pinjaman Aktif --> J[Tampilkan Sisa Hutang & Tagihan Bulan Ini]:::screen
    I -- Tidak Ada Pinjaman --> K[Tampilkan Limit Max Rp 12.000.000]:::screen
    
    K --> L(Klik Tombol 'Ajukan Pinjaman')
    L --> M[Loan Application Form Screen]:::screen
    M -->|Input Nominal & Pilih Tenor Max 12 Bln| N[Proses Pengajuan]:::process
    
    N --> O{Approval System / CRM}:::decision
    
    O -- Diterima --> P[Notifikasi Sukses via Email & SMS]:::process
    O -- Ditolak --> Q[Notifikasi Ditolak via Email & SMS]:::process
    
    P --> J
    Q --> K
```

[![](https://mermaid.ink/img/pako:eNqVVGtv2jAU_SuWpe1TqEJ45xsqYaLlJR7VNCFFhtwmLo6d-aGto_z32aS0wOimWUr8uPdc2-f43h3eiARwiEH2KEklyVcc2fbpE5oBI5oKrjJaqHJ1OY9mc_TyUqmIHRpOuuM5CtEK58BT8mS2hK9w6VjaXh0H4_miOxyOovHi6J9TRrcUaZLS7B31tvWCrBko9Bn1KbDkbPNdOXHNGJogo0DGtp_e28BTSXMin9E9PB9juqa0pDxFj4axmJMc0B8myAllNsCS0-8GrmCLTHCIucnXIP_mt9VFbM-QQmykC9ijiuYF4SihaF67AlDAHin8H6YgSv0QMokzorJ361oIBhZGVbymIgfrvImBOy4TG3ZSKIqOhi1iIqX8NHhCNGhq2dlIsMMkJro07k_VKZW9VIEJwksVPpCn7-TpCwk05U4etAW0tDZ1dgLYWB4YIrkwXFvAiGzVYWVWoGpw4_u--04h1Ppp4ELGueA6U6eganCNb020cW7ReDkK0TQa9wbjLx7qTqezyUPU89AsuotuF27UvV0MHiIPTbuDXjzp96-yRYqC0RO2zoymSD6m8iwvLhml3J6UMZta-iqxR8avETu0NnXJ0oGfWIF9t3wD7g1Lo-1rWRtm_1uofP1YijgxDnFnckayy6w9XhhZp_gwWOEF4Wlq4U-WbAuAvBD_1mI5dkSXdHto2F1ER8weeziVNMGhlgY8W0CkTVg7xQfaVlhnkNt0dMUlIXLrcA5jk-ibEPkRJoVJMxw-EqbsrNTmteq9rUrgCchbd2sc1jr-IQgOd_gnDqvN4Caot1p-0Aqa7Ua7UfPwMw4r1Ub9pt3pdJq1oOoHzaDe3nv412Hj6o3faLSanUY1qPntdlAPPAwJ1UKOyrp7KL_73zdLsIo?type=png)](https://mermaid.ai/live/edit#pako:eNqVVGtv2jAU_SuWpe1TqEJ45xsqYaLlJR7VNCFFhtwmLo6d-aGto_z32aS0wOimWUr8uPdc2-f43h3eiARwiEH2KEklyVcc2fbpE5oBI5oKrjJaqHJ1OY9mc_TyUqmIHRpOuuM5CtEK58BT8mS2hK9w6VjaXh0H4_miOxyOovHi6J9TRrcUaZLS7B31tvWCrBko9Bn1KbDkbPNdOXHNGJogo0DGtp_e28BTSXMin9E9PB9juqa0pDxFj4axmJMc0B8myAllNsCS0-8GrmCLTHCIucnXIP_mt9VFbM-QQmykC9ijiuYF4SihaF67AlDAHin8H6YgSv0QMokzorJ361oIBhZGVbymIgfrvImBOy4TG3ZSKIqOhi1iIqX8NHhCNGhq2dlIsMMkJro07k_VKZW9VIEJwksVPpCn7-TpCwk05U4etAW0tDZ1dgLYWB4YIrkwXFvAiGzVYWVWoGpw4_u--04h1Ppp4ELGueA6U6eganCNb020cW7ReDkK0TQa9wbjLx7qTqezyUPU89AsuotuF27UvV0MHiIPTbuDXjzp96-yRYqC0RO2zoymSD6m8iwvLhml3J6UMZta-iqxR8avETu0NnXJ0oGfWIF9t3wD7g1Lo-1rWRtm_1uofP1YijgxDnFnckayy6w9XhhZp_gwWOEF4Wlq4U-WbAuAvBD_1mI5dkSXdHto2F1ER8weeziVNMGhlgY8W0CkTVg7xQfaVlhnkNt0dMUlIXLrcA5jk-ibEPkRJoVJMxw-EqbsrNTmteq9rUrgCchbd2sc1jr-IQgOd_gnDqvN4Caot1p-0Aqa7Ua7UfPwMw4r1Ub9pt3pdJq1oOoHzaDe3nv412Hj6o3faLSanUY1qPntdlAPPAwJ1UKOyrp7KL_73zdLsIo)

### Desain Screen Flow & ERD
...
```mermaid
  sequenceDiagram
    ...
    participant CRM as CRM / Approval Engine
    participant Notif as Notification Service

    Client->>Gateway: POST /api/v1/loans/apply {amount, tenor}
    Gateway->>Gateway: Validate JWT Token
    Gateway->>Loan: Forward Request
    
    %% Rule: Check if user has active loan
    Loan->>DB: Query: Cek pinjaman aktif (user_id)
    DB-->>Loan: Return status pinjaman
    
    alt Terdapat Pinjaman Aktif (Belum Lunas)
        Loan-->>Gateway: HTTP 400 Bad Request
        Gateway-->>Client: { "error": "Anda masih memiliki pinjaman aktif" }
    else Tidak Ada Pinjaman Aktif
        %% Proceed with application
        Loan->>DB: INSERT into LOANS (status: PENDING)
        DB-->>Loan: loan_id generated
        
        %% Trigger Approval
        Loan->>CRM: Trigger Credit Scoring (Async/Sync)
        CRM-->>Loan: Return Decision (APPROVED / REJECTED)
        
        %% Update Status
        Loan->>DB: UPDATE LOANS (status: Decision)
        
        %% Send Notification
        par Asynchronous Notification
            Loan-)+Notif: Publish Event (Kirim Email & SMS)
            Notif-->>Client: Mengirim Notifikasi Status (Diterima/Ditolak)
        end
        
        %% Return Response to Client
        Loan-->>Gateway: HTTP 201 Created
        Gateway-->>Client: { "status": "Success", "decision": "..." }
    end
  ```
 **Request Body Payload API**
  {
  "amount": 10000000, 
  "tenor_months": 12  
}
...
**Response success (200)**
{
  "code": 201,
  "status": "success",
  "message": "Pengajuan pinjaman berhasil diproses.",
  "data": {
    "loan_id": "uuid-1234-5678",
    "decision": "APPROVED",
...
**Response failed 404**
{
  "code": 400,
  "status": "error",
  "message": "Pengajuan ditolak. Anda tidak dapat melakukan peminjaman uang jika sedang ada proses peminjaman yang belum dilunaskan."
}
...
```mermaid
flowchart TD
    s1["Got it: Ikon"] --> s2["Kalender: Penunjuk Pengajuan"]
    s3["Cek Token di Secure Storage"] --> s5["Redirect ke Home Dashboard"]
    s5 --> s6{"Verifikasi Liveness?"}
    s6 -->|"No"| s7["Redirect ke Onboarding/Auth Screen"]
    s6 -->|"Yes"| s8["Buka Kamera Native"]
    s9["Lakukan Real-Time OCR dan Pencocokan Wajah"] --> s10["Sistem Validasi Sukses?"]
    s10 -->|"No"| s11["Tanya: Simpan Token di Secure Storage?"]
    s10 -->|"Yes"| s12["Navigasi ke Home/Dashboard"]
    s12 --> s13["Banner Pemberitahuan: Sisa Hutang & Tagihan Bulan Ini"]
    s13 --> s14["Tanya: Ada Pinjaman Aktif?"]
    s14 -->|"No"| s15["Pengajuan Pinjaman: Input Nominal"]
    s14 -->|"Ya"| s16["Input Estimasi Cicilan Per Bulan"]
    s16 --> s17["Tanya: Simpan Deposit dan Pengajuan"]
    s17 -->|"Ya"| s18["Modal Bottom Sheet: Diterima/Rejection"]
    s18 --> s19["Diterima: Pop-Up Hijau, Auto-Refresh ke Dashboard"]
    s18 -->|"Tidak"| s20["Ditolak: Pop-Up Merah"]

    %% Merging pathways at the bottom
...
### Analisis 
1. Pencegahan Kesalahan (Error Prevention): Memblokir input nominal pinjaman lebih dari Rp 12.000.000 secara real-time di antarmuka (tanpa harus menunggu menekan tombol submit) merupakan penerapan prinsip UX Heuristics (Error Prevention). Ini menghemat bandwidth API dan memberikan umpan balik langsung kepada pengguna.

2. Dynamic Dashboard State: Mengubah tampilan Dashboard secara drastis berdasarkan ada atau tidaknya pinjaman aktif adalah cara paling efektif untuk menegakkan aturan bisnis utama ("Tidak boleh meminjam lagi jika belum lunas") tanpa membuat pengguna bingung. Menyembunyikan tombol "Ajukan Pinjaman" mencegah munculnya frustrasi pengguna akibat penolakan dari backend.

3. Native Hardware Integration: Pemanfaatan BiometricPrompt untuk login tidak hanya mempercepat proses (mengurangi hambatan masuk / friction), tetapi juga meningkatkan standar keamanan akses aplikasi fintech.
